...
function updateServicesBackgrounds(weatherCode, weatherDescription) {
    ...
    switch (weatherCode) {
        ...
        case "1101": // Delvis molnigt
            ...
            break;
        // Lägg till fler fall baserat på väderkoder om du har fler bilder
        default:
            locationBg = "/images/cloudy.jpg"; // Eller annan default bild
            playlistBg = "/images/cloudy.jpg"; // Eller annan default bild
            break;
    }
